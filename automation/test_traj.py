...
ax0_current = ax0_inpos - (ax0_position - ax0_zero)/cpr
ax1_current = ax1_inpos - (ax1_position - ax1_zero)/cpr
...
# try doing some motion here
turn_angle = 0.2        # this is how much both motors will spin in full deflection

for i in range(0,10):
    print('Flip ..')
    odrv0.axis0.controller.input_pos = ax0_current + turn_angle
    odrv0.axis1.controller.input_pos = ax1_current + turn_angle
